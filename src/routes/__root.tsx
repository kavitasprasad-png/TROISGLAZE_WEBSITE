    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-md bg-navy px-5 py-2.5 text-sm font-medium text-navy-foreground hover:bg-navy/90 transition-colors"
          >
            Go home
          </Link>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Trois Glaze — Engineering Skylines. Creating Landmarks." },
      ...
      { name: "author", content: "Trois Glaze" },
      { property: "og:title", content: "Trois Glaze — Engineering Skylines. Creating Landmarks." },
      ...
      { name: "twitter:title", content: "Trois Glaze — Engineering Skylines. Creating Landmarks." },
      { name: "twitter:description", content: "Premium façade, fenestration and louvre solutions engineered for iconic buildings." },
    ],
    links: [
